      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl my-auto">
        ...
        <div className="px-6 py-5 space-y-6 overflow-y-auto max-h-[calc(100vh-200px)]">
          ...
          <section className="space-y-4">
            ...
            {(() => {
              const showCompleted = !!form.completedDate || ["Sold", "Donated", "Discarded"].includes(form.status ?? "");
              const showApproved = !!item.approvedDate || (form.status !== "Pending Review");
              const approvedLocked = form.status !== "Pending Review";
              if (!showCompleted && !showApproved) return null;
              return (
                  ...
                  {showApproved && (
                    <div>
                      <label className={labelClass}>
                        ...
                        {approvedLocked && (
                          <span className="ml-1 text-gray-400 font-normal">
                            <svg className="inline w-3 h-3 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      ...
                      <input
                        ...
                        className={`w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-forest-500 focus:border-transparent ${approvedLocked ? "bg-gray-50 text-gray-500 cursor-not-allowed" : ""}`}
                      />
                      {item.approvedByName && (
