          ...
          {shifts.map((shift) => (
            <div key={shift.id} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
              ...
              <div className="space-y-2.5">
                ...
                {/* Client contact */}
                {(shift.clientPhone || shift.clientEmail) && (
                  <div className="flex items-center gap-4 flex-wrap">
                    {shift.clientPhone && (
                      <a
                        href={`tel:${shift.clientPhone.replace(/\D/g, "")}`}
                      ...
                      >
                        ...
                        <span className="font-medium">{shift.clientPhone}</span>
                      </a>
                    )}
                    {shift.clientEmail && (
                      <a
                      ...
                      >
                        ...
                        <span className="font-medium">{shift.clientEmail}</span>
                      </a>
                    )}
                  </div>
                )}
