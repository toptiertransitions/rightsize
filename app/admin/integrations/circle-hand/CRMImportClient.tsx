...
const CONFIGS: Record<ImportType, {
  ...
  "referral-contacts": {
    ...
    columns: ["Name", "Title", "Email", "Phone", "Company", "Stage", "Date Introduced", "Interests", "Coffee Order", "Orgs/Groups", "Owner", "Notes"],
    templateHeaders: ["Name", "Title", "Email", "Phone", "Company", "Stage", "Date Introduced", "Interests", "Coffee Order", "Orgs/Groups", "Owner", "Notes"],
    templateExample: [
      "Bob Jones",
      "Director of Care",
      "bob@sunrise.com",
