...
const STAFF_ROLES = [
  ...
  },
  {
    ...
    desc: "Sales team with access to CRM, quoting, invoicing, drip campaigns, and expenses. Expenses are non-reimbursable by default.",
  },
  {
    key: "TTTAdmin",
    label: "TTT Admin",
...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "Ops tab (/staff)",            permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
