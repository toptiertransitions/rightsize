...
const STAFF_ROLES = [
  {
    ...
    desc: "Field staff who log time, access client project data, edit sale prices, view Venmo/Zelle payment QR codes on the Sales page, edit project addresses from /home, assign themselves as Staff Seller on FB/Online Marketplace items, filter the Catalog by staff seller, and submit & associate expenses with projects.",
  },
  {
    key: "TTTManager",
    label: "TTT Manager",
    ...
    desc: "Operations leads with full project, quoting, invoicing, expense, subcontractor, and time-tracking access. Can reassign items between projects, configure payout settings, manage payment handles, and access the Ops console.",
  },
  {
    key: "TTTSales",
    label: "TTT Sales",
