...
const STAFF_ROLES = [
  ...
  },
  {
    ...
    desc: "Operations leads with full project, quoting, invoicing, expense, subcontractor, and time-tracking access. Can reassign items between projects, configure payout settings, manage payment handles, and access the Ops console. Expenses are reimbursable by default.",
  },
  {
    key: "TTTSales",
    label: "TTT Sales",
    ...
    desc: "Sales team with access to CRM, quoting, invoicing, drip campaigns, expenses, and the Ops console. Expenses are non-reimbursable by default.",
  },
  {
    key: "TTTAdmin",
    label: "TTT Admin",
...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "Access Ops console (/admin/ops)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: true, TTTSales: true, TTTAdmin: true } },
