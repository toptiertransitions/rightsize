...
const STAFF_ROLES = [
  ...
  },
  {
    ...
    desc: "Sales team with access to CRM, Outreach (sequences, broadcasts, My Day), quoting, invoicing, expenses, the Staff page, and internal project notes on /plan. Expenses are non-reimbursable by default.",
  },
  {
    key: "TTTAdmin",
    label: "TTT Admin",
