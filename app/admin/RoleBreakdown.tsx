...
const STAFF_ROLES = [
  ...
  },
  {
    ...
    desc: "Operations leads with expense tracking and full time visibility.",
  },
  {
    key: "TTTSales",
    label: "TTT Sales",
    ...
    desc: "Sales team focused on the CRM pipeline and new client acquisition.",
  },
  {
    key: "TTTAdmin",
    label: "TTT Admin",
...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "Invoices tab",               permissions: { Owner: true,  Collaborator: true,  Viewer: true,  TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  ...
  { label: "Quoting tab",                 permissions: { Owner: false, Collaborator: false, Viewer: false, TTTStaff: false, TTTManager: false, TTTSales: false, TTTAdmin: true  } },
  ...
  { group: "Invoices" },
  { label: "View invoices & PDF",        permissions: { Owner: true,  Collaborator: true,  Viewer: true,  TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  { label: "Create invoices",            permissions: { Owner: false, Collaborator: false, Viewer: false, TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  { label: "Mark invoices paid",         permissions: { Owner: false, Collaborator: false, Viewer: false, TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  { group: "Time Tracking" },
