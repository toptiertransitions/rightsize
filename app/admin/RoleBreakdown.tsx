...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "Add & edit Key Date entries (Start, Move, Pickup, Estate Sale, Close)", permissions: { Owner: true, Collaborator: true, Viewer: false, NonTTTOwner: true, TTTStaff: true, TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { label: "Edit project Origin & Destination on /plan",      permissions: { Owner: true,  Collaborator: true,  Viewer: false, NonTTTOwner: true,  TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  { label: "Assign Team Lead on project (from /plan)",        permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: true,  TTTSales: false, TTTAdmin: true  } },
  ...
  { label: "Search catalog by Estate Sale ID", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: true, TTTManager: true, TTTSales: false, TTTAdmin: true } },
  ...
  { label: "'Not Included in this Scope' section on contract (edit when quoting, view when signing)", permissions: { Owner: "view-only", Collaborator: "view-only", Viewer: "view-only", NonTTTOwner: false, TTTStaff: false, TTTManager: true, TTTSales: true, TTTAdmin: true } },
  ...
  { group: "CRM Plan" },
  { label: "CRM Plan — Team View leaderboard (all reps, goals, pacing)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: "view-only", TTTAdmin: true } },
  { label: "CRM Plan — Individual rep view (TTTSales defaults to own; TTTAdmin can open any rep)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { label: "CRM Plan — Create quarters and edit date ranges", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: false, TTTAdmin: true } },
  { label: "CRM Plan — Set rep quarterly referral goals (click-to-edit in leaderboard)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: false, TTTAdmin: true } },
  { label: "CRM Plan — Add companies from pipeline to any rep's Not Yet Referring list", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: false, TTTAdmin: true } },
  { label: "CRM Plan — Remove companies from Not Yet Referring list", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { label: "CRM Plan — Quarter's Plan: key meetings, key resources, monthly goals per company", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { label: "CRM Plan — Compare Activity AI (AI assessment of plan items vs logged activities)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { label: "CRM Plan — Activity vs Goals tracker (per-month meeting and checkin counts vs monthly goals, color-coded)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { label: "Gmail sync — sync email to CRM contact activity log (from Settings)", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: false, TTTSales: true, TTTAdmin: true } },
  { group: "Sales & Payouts" },
  ...
  { label: "Set unsold item standard preference (Donate / Return) on /sales", permissions: { Owner: true, Collaborator: true, Viewer: "view-only", NonTTTOwner: false, TTTStaff: "view-only", TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { label: "Add / remove unsold item special situations (per-item exceptions) on /sales", permissions: { Owner: true, Collaborator: true, Viewer: "view-only", NonTTTOwner: false, TTTStaff: "view-only", TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { label: "View consignment pricing expectations (price drop schedule & dates) on /sales", permissions: { Owner: true, Collaborator: true, Viewer: true, NonTTTOwner: false, TTTStaff: true, TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { label: "Edit consignment pricing expectations (days from delivery & % per drop) on /sales", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { label: "Send price drop / unsold items notification emails (to self) from /sales", permissions: { Owner: false, Collaborator: false, Viewer: false, NonTTTOwner: false, TTTStaff: false, TTTManager: true, TTTSales: false, TTTAdmin: true } },
  { group: "Staff Pay" },
