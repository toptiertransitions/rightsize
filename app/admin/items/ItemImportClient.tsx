...
const ROUTE_COLORS: Record<string, string> = {
  ...
  "To Be Moved": "bg-green-900/50 text-green-300 border-green-600",
  "Family to Take": "bg-gray-700/50 text-gray-300 border-gray-600",
  "Storage Unit - Offsite": "bg-cyan-900/50 text-cyan-300 border-cyan-700",
  "Leaving with Home": "bg-lime-900/50 text-lime-300 border-lime-700",
