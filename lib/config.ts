...
export const AIRTABLE_TABLES = {
  ...
  SUPPLY_STORAGE_UNITS: process.env.AIRTABLE_SUPPLY_STORAGE_UNITS_TABLE || "SupplyStorageUnits",
  PF_OPEN_HOUSE_DATES: process.env.AIRTABLE_PF_OPEN_HOUSE_DATES_TABLE || "PFOpenHouseDates",
